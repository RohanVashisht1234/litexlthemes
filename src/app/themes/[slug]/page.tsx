  ...
  return (
    <>
      <section className="bg-white dark:bg-gray-900">
            ...
            <div className="w-full max-w-[16rem] mb-5">
              <div className="relative">
                ...
                <input
                  ...
                  value={"lpm install " + addon_data.id}
                  disabled={false}
                  readOnly={false}
                />
                <button
        ...
        <div className="flex justify-center">
          <div className="block">
            <div className="flex space-x-2">
              <h4 className="flex bg-[#2b2b2b] p-4 w-fit rounded">
                <SiLua className="h-6 w-6 mr-1" />
                <span id="get_filename_from_here">{correct_addon}.lua</span>
              </h4>
              <button
                id="copy_lua_file"
                className="capitalize bg-[#2b2b2b] p-4 w-fit rounded"
              >
                Copy to clipboard
              </button>
            </div>
            <SyntaxHighlighter
              language="lua"
              className="relative w-[calc(100vw-20px)] sm:max-w-4xl mx-auto rounded-3xl dark:border-gray-700 yt-video"
              style={a11yDark}
            >
              {codeString}
            </SyntaxHighlighter>
        ...
        <div id="get_data_from_here" className="hidden">
          {codeString}
        </div>
      </section>
      <Script strategy='beforeInteractive' src="/copy_to_clipboard.js"></Script>
    </>
  );
}
